...
## [1.4.1.0] - 2026-04-20 — Oracle fork sync

Merged upstream v1.4.0.0 (make-pdf, UX foundations, gstack v1, Puppeteer parity, context-save/restore, plan-tune, benchmark-models, open-agents learnings, AI slop reduction). Oracle remains intact on this fork.
