...
## [1.6.2.0] - 2026-04-23 — Oracle fork sync

Merged upstream v1.6.1.0 (Opus 4.7 migration, security wave v1.6.0.0 dual-listener tunnel + SSRF/envelope/path fixes, make-pdf v1.5.1.0 page-number + entity + Linux font fixes, ML prompt injection defense v1.5.0.0). Oracle remains intact on this fork.
